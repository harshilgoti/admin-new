        ...
        {data.labels.map((label, index) => (
          <div key={label} className="px-16 flex flex-col items-center">
            ...
            <div className="flex flex-row items-center justify-center">
              {data.datasets[dataset][0].change[index] < 0 && <Icon className="text-18 text-red">arrow_downward</Icon>}

              {data.datasets[dataset][0].change[index] > 0 && <Icon className="text-18 text-green">arrow_upward</Icon>}
